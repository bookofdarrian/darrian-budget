# 📱 Darrian Belcher — Social Media Copy (March 2026)
> Copy-paste ready. Update each platform manually — all copy is below.
...
What drives me:
— Community sovereignty. Keeping money, knowledge, and power in the hands of the people who need it most.
— HBCU pride. NC A&T. Forever Aggie.
— The marathon mentality. Build in silence. Release with purpose.
— Technology as liberation, not just employment.

I'm 22. I'm just getting started. And yes — I built all of this.

📍 Virginia · North Carolina · The Peach State
🏛️ NC A&T State University
💻 Python · Streamlit · PostgreSQL · Docker · Claude AI · Stripe
...
1. **Link** → peachstatesavings.com with title: "Peach State Savings — Personal Finance OS I Built From Scratch"
2. **Post** → Your SDLC/LinkedIn post about the 688-commit journey
3. **Link** → github.com/bookofdarrian
...
## 🐙 GITHUB PROFILE (github.com/bookofdarrian)

**Profile README** — Create a repo named `bookofdarrian/bookofdarrian` with this README.md:

```markdown
# 👋 Darrian Belcher — @bookofdarrian
...
## 🍑 Main Project: Peach State Savings
**[peachstatesavings.com](https://peachstatesavings.com)**

A personal finance OS I built entirely from scratch.

| 📄 154+ pages | 💾 92K+ lines | 🔀 688+ commits | 🧪 100+ tests |
|---|---|---|---|

**Stack:** Python · Streamlit · PostgreSQL · Docker · Claude AI · Stripe · Proxmox

---

## 🔨 What I Build

- 💰 **Peach State Savings** — Full personal finance OS (self-hosted, production-grade)
- 👟 **SoleOps** — AI-powered sneaker resale platform for 404 Sole Archive
- 🎬 **The Marathon Studio** — Private creative studio for manga, film, and shows
- 🤖 **AI Agents** — Overnight orchestrators, morning briefings, career intelligence
...
Voice:      OpenAI Whisper (local, on-device)
```
...
## 🌍 Connect
🌐 [peachstatesavings.com](https://peachstatesavings.com)  
💼 [LinkedIn](https://linkedin.com/in/darrianbelcher)  
🐦 [X/Twitter](https://twitter.com/bookofdarrian)  
📸 [Instagram](https://instagram.com/bookofdarrian)

---

*NC A&T 🐾 · Virginia · The Peach State · The Marathon Continues 💜*
```

---

## 🐦 X / TWITTER (@bookofdarrian)
...
### Pinned Tweet (write this and pin it)
```
built peachstatesavings.com from scratch

154 pages.
92,000 lines of code.
688 commits.
self-hosted on my own home lab.
3 subscription tiers (one invite-only).
ci/cd pipeline across 5 environments.
ai that runs overnight and reports back.
a sneaker resale platform inside it.
a private creative studio.
a whisper voice dictation daemon.
...
### Story Highlight Names (create these)
- `💰 The App` — screenshots of peachstatesavings.com
- `👟 SoleOps` — sneaker resale content
- `🎬 Creator` — bookofdarrian / College Confused content
- `🏠 Homelab` — server setup, tech content
- `🐾 A&T` — HBCU pride content

---

## 🎵 TIKTOK (@bookofdarrian)
...
1. **"I built a 154-page app in my free time while working at Visa"** — screen tour
2. **"My home lab runs peachstatesavings.com (this is how)"** — Proxmox walkthrough
3. **"How I track every sneaker I flip with AI"** — SoleOps demo
4. **"22 with RSUs, Stripe payments, and a self-hosted server"** — day in my life
5. **"HBCU → Visa → building my own empire"** — origin story
...
GitHub: github.com/bookofdarrian
```

---

## 🔱 UNIVERSAL BIO (for anywhere else)
...
*Last updated: March 2026 | peachstatesavings.com*
