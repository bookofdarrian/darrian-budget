...
PAGE_PATH = os.path.join(ROOT, "pages/83_social_security_estimator.py")
...
def test_required_patterns():
    """Social Security Benefits Estimator page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Social Security Benefits Estimator page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Social Security Benefits Estimator — basic file sanity."""
    assert "social_security_estimator" != ""
