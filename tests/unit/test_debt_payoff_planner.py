...
PAGE_PATH = os.path.join(ROOT, "pages/45_debt_payoff_planner.py")
...
def test_required_patterns():
    """Debt Payoff Planner page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Debt Payoff Planner page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Debt Payoff Planner — basic file sanity."""
    assert "debt_payoff_planner" != ""
