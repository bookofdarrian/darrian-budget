...
PAGE_PATH = os.path.join(ROOT, "pages/124_soleops_return_refund_tracker.py")
...
def test_required_patterns():
    """SoleOps: Return & Refund Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """SoleOps: Return & Refund Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """SoleOps: Return & Refund Tracker — basic file sanity."""
    assert "soleops_return_refund_tracker" != ""
