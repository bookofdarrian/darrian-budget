...
PAGE_PATH = os.path.join(ROOT, "pages/99_cc_campus_visit_planner.py")
...
def test_required_patterns():
    """CC: Campus Visit Planner page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """CC: Campus Visit Planner page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """CC: Campus Visit Planner — basic file sanity."""
    assert "cc_campus_visit_planner" != ""
