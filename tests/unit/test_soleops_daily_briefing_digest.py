...
PAGE_PATH = os.path.join(ROOT, "pages/133_soleops_daily_briefing_digest.py")
...
def test_required_patterns():
    """SoleOps Daily Briefing Digest page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """SoleOps Daily Briefing Digest page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """SoleOps Daily Briefing Digest — basic file sanity."""
    assert "soleops_daily_briefing_digest" != ""
