...
PAGE_PATH = os.path.join(ROOT, "pages/70_paycheck_calculator_v2.py")
...
def test_required_patterns():
    """Paycheck Calculator v2 page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Paycheck Calculator v2 page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Paycheck Calculator v2 — basic file sanity."""
    assert "paycheck_calculator_v2" != ""
