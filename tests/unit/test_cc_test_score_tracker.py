...
PAGE_PATH = os.path.join(ROOT, "pages/98_cc_test_score_tracker.py")
...
def test_required_patterns():
    """CC: Test Score Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """CC: Test Score Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """CC: Test Score Tracker — basic file sanity."""
    assert "cc_test_score_tracker" != ""
