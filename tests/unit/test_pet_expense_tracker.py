...
PAGE_PATH = os.path.join(ROOT, "pages/81_pet_expense_tracker.py")
...
def test_required_patterns():
    """Pet Expense Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Pet Expense Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Pet Expense Tracker — basic file sanity."""
    assert "pet_expense_tracker" != ""
