...
PAGE_PATH = os.path.join(ROOT, "pages/79_financial_goal_simulator.py")
...
def test_required_patterns():
    """Financial Goal Simulator page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Financial Goal Simulator page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Financial Goal Simulator — basic file sanity."""
    assert "financial_goal_simulator" != ""
