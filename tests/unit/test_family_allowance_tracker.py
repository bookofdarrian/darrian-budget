...
PAGE_PATH = os.path.join(ROOT, "pages/100_family_allowance_tracker.py")
...
def test_required_patterns():
    """Family Allowance Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Family Allowance Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Family Allowance Tracker — basic file sanity."""
    assert "family_allowance_tracker" != ""
