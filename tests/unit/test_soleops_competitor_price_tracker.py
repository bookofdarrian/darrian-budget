...
PAGE_PATH = os.path.join(ROOT, "pages/131_soleops_competitor_price_tracker.py")
...
def test_required_patterns():
    """SoleOps Competitor Price Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """SoleOps Competitor Price Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """SoleOps Competitor Price Tracker — basic file sanity."""
    assert "soleops_competitor_price_tracker" != ""
