...
PAGE_PATH = os.path.join(ROOT, "pages/61_net_worth_goal_tracker.py")
...
def test_required_patterns():
    """Net Worth Goal Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Net Worth Goal Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Net Worth Goal Tracker — basic file sanity."""
    assert "net_worth_goal_tracker" != ""
