...
PAGE_PATH = os.path.join(ROOT, "pages/135_soleops_drop_calendar.py")
...
def test_required_patterns():
    """SoleOps Drop Calendar page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """SoleOps Drop Calendar page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """SoleOps Drop Calendar — basic file sanity."""
    assert "soleops_drop_calendar" != ""
