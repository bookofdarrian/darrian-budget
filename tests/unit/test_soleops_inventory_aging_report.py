...
PAGE_PATH = os.path.join(ROOT, "pages/119_soleops_inventory_aging_report.py")
...
def test_required_patterns():
    """SoleOps: Inventory Aging Report page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """SoleOps: Inventory Aging Report page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """SoleOps: Inventory Aging Report — basic file sanity."""
    assert "soleops_inventory_aging_report" != ""
