...
PAGE_PATH = os.path.join(ROOT, "pages/154_video_ai_studio_v8.py")
...
def test_required_patterns():
    """Video AI Studio V8 page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Video AI Studio V8 page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Video AI Studio V8 — basic file sanity."""
    assert "video_ai_studio_v8" != ""
