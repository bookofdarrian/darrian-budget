...
PAGE_PATH = os.path.join(ROOT, "pages/69_net_worth_projection.py")
...
def test_required_patterns():
    """Net Worth Projection page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Net Worth Projection page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Net Worth Projection — basic file sanity."""
    assert "net_worth_projection" != ""
