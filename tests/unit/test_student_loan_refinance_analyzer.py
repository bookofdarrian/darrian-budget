...
PAGE_PATH = os.path.join(ROOT, "pages/82_student_loan_refinance_analyzer.py")
...
def test_required_patterns():
    """Student Loan Refinance Analyzer page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Student Loan Refinance Analyzer page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Student Loan Refinance Analyzer — basic file sanity."""
    assert "student_loan_refinance_analyzer" != ""
