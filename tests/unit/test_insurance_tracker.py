...
PAGE_PATH = os.path.join(ROOT, "pages/72_insurance_tracker.py")
...
def test_required_patterns():
    """Insurance Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Insurance Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Insurance Tracker — basic file sanity."""
    assert "insurance_tracker" != ""
