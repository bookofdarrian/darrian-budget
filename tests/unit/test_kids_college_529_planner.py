...
PAGE_PATH = os.path.join(ROOT, "pages/78_kids_college_529_planner.py")
...
def test_required_patterns():
    """Kids College 529 Planner page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Kids College 529 Planner page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Kids College 529 Planner — basic file sanity."""
    assert "kids_college_529_planner" != ""
