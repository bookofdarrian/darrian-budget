...
PAGE_PATH = os.path.join(ROOT, "pages/105_soleops_weekly_reseller_report.py")
...
def test_required_patterns():
    """SoleOps Weekly Reseller Report Email page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """SoleOps Weekly Reseller Report Email page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """SoleOps Weekly Reseller Report Email — basic file sanity."""
    assert "soleops_weekly_reseller_report" != ""
