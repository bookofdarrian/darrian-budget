...
PAGE_PATH = os.path.join(ROOT, "pages/102_annual_tax_projection_dashboard.py")
...
def test_required_patterns():
    """Annual Tax Projection Dashboard page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Annual Tax Projection Dashboard page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Annual Tax Projection Dashboard — basic file sanity."""
    assert "annual_tax_projection_dashboard" != ""
