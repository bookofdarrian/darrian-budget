...
PAGE_PATH = os.path.join(ROOT, "pages/36_monthly_financial_email_report.py")
...
def test_required_patterns():
    """Monthly Financial Email Report page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Monthly Financial Email Report page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Monthly Financial Email Report — basic file sanity."""
    assert "monthly_financial_email_report" != ""
