...
PAGE_PATH = os.path.join(ROOT, "pages/73_grocery_budget_tracker.py")
...
def test_required_patterns():
    """Grocery Budget Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Grocery Budget Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Grocery Budget Tracker — basic file sanity."""
    assert "grocery_budget_tracker" != ""
