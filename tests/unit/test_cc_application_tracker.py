...
PAGE_PATH = os.path.join(ROOT, "pages/93_cc_application_tracker.py")
...
def test_required_patterns():
    """CC: Application Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """CC: Application Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """CC: Application Tracker — basic file sanity."""
    assert "cc_application_tracker" != ""
