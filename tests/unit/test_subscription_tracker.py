...
PAGE_PATH = os.path.join(ROOT, "pages/76_subscription_tracker.py")
...
def test_required_patterns():
    """Subscription Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Subscription Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Subscription Tracker — basic file sanity."""
    assert "subscription_tracker" != ""
