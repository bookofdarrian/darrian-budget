...
PAGE_PATH = os.path.join(ROOT, "pages/95_cc_interview_prep_ai.py")
...
def test_required_patterns():
    """CC: Interview Prep AI page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """CC: Interview Prep AI page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """CC: Interview Prep AI — basic file sanity."""
    assert "cc_interview_prep_ai" != ""
