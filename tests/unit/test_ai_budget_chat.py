...
PAGE_PATH = os.path.join(ROOT, "pages/55_ai_budget_chat.py")
...
def test_required_patterns():
    """AI Budget Chat Assistant page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """AI Budget Chat Assistant page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """AI Budget Chat Assistant — basic file sanity."""
    assert "ai_budget_chat" != ""
