...
PAGE_PATH = os.path.join(ROOT, "pages/74_home_equity_dashboard.py")
...
def test_required_patterns():
    """Home Equity Dashboard page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Home Equity Dashboard page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Home Equity Dashboard — basic file sanity."""
    assert "home_equity_dashboard" != ""
