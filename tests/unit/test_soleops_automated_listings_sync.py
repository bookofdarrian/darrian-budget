...
PAGE_PATH = os.path.join(ROOT, "pages/126_soleops_automated_listings_sync.py")
...
def test_required_patterns():
    """SoleOps Automated Listings Sync page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """SoleOps Automated Listings Sync page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """SoleOps Automated Listings Sync — basic file sanity."""
    assert "soleops_automated_listings_sync" != ""
