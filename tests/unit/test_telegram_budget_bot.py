...
PAGE_PATH = os.path.join(ROOT, "pages/49_telegram_budget_bot.py")
...
def test_required_patterns():
    """Telegram Budget Bot page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Telegram Budget Bot page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Telegram Budget Bot — basic file sanity."""
    assert "telegram_budget_bot" != ""
