...
PAGE_PATH = os.path.join(ROOT, "pages/41_health_cost_tracker.py")
...
def test_required_patterns():
    """Health Cost Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Health Cost Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Health Cost Tracker — basic file sanity."""
    assert "health_cost_tracker" != ""
