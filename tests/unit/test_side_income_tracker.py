...
PAGE_PATH = os.path.join(ROOT, "pages/64_side_income_tracker.py")
...
def test_required_patterns():
    """Side Income Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Side Income Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Side Income Tracker — basic file sanity."""
    assert "side_income_tracker" != ""
