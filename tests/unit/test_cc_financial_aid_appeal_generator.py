...
PAGE_PATH = os.path.join(ROOT, "pages/96_cc_financial_aid_appeal_generator.py")
...
def test_required_patterns():
    """CC: Financial Aid Appeal Generator page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """CC: Financial Aid Appeal Generator page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """CC: Financial Aid Appeal Generator — basic file sanity."""
    assert "cc_financial_aid_appeal_generator" != ""
