...
PAGE_PATH = os.path.join(ROOT, "pages/57_family_budget_sharing.py")
...
def test_required_patterns():
    """Family Budget Sharing page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Family Budget Sharing page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Family Budget Sharing — basic file sanity."""
    assert "family_budget_sharing" != ""
