...
PAGE_PATH = os.path.join(ROOT, "pages/91_web_analytics_dashboard.py")
...
def test_required_patterns():
    """Web Analytics Dashboard page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Web Analytics Dashboard page must not contain hardcoded API keys or passwords."""
    src = _source()
    forbidden = ["sk-ant-", "password=", "secret=", "hardcoded"]
...
def test_feature_metadata():
    """Web Analytics Dashboard — basic file sanity."""
    assert "web_analytics_dashboard" != ""
