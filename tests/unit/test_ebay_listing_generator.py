...
PAGE_PATH = os.path.join(ROOT, "pages/60_ebay_listing_generator.py")
...
def test_required_patterns():
    """eBay Listing Generator page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """eBay Listing Generator page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """eBay Listing Generator — basic file sanity."""
    assert "ebay_listing_generator" != ""
