...
PAGE_PATH = os.path.join(ROOT, "pages/101_charitable_donation_tracker.py")
...
def test_required_patterns():
    """Charitable Donation Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Charitable Donation Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Charitable Donation Tracker — basic file sanity."""
    assert "charitable_donation_tracker" != ""
