...
PAGE_PATH = os.path.join(ROOT, "pages/62_dividend_income_tracker.py")
...
def test_required_patterns():
    """Dividend Income Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Dividend Income Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Dividend Income Tracker — basic file sanity."""
    assert "dividend_income_tracker" != ""
