...
PAGE_PATH = os.path.join(ROOT, "pages/51_tax_document_vault.py")
...
def test_required_patterns():
    """Tax Document Vault page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Tax Document Vault page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Tax Document Vault — basic file sanity."""
    assert "tax_document_vault" != ""
