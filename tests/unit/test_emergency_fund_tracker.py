...
PAGE_PATH = os.path.join(ROOT, "pages/50_emergency_fund_tracker.py")
...
def test_required_patterns():
    """Emergency Fund Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Emergency Fund Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Emergency Fund Tracker — basic file sanity."""
    assert "emergency_fund_tracker" != ""
