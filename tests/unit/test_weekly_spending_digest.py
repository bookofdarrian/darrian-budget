...
PAGE_PATH = os.path.join(ROOT, "pages/56_weekly_spending_digest.py")
...
def test_required_patterns():
    """Weekly Spending Digest page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Weekly Spending Digest page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Weekly Spending Digest — basic file sanity."""
    assert "weekly_spending_digest" != ""
