...
PAGE_PATH = os.path.join(ROOT, "pages/45_uptime_kuma_status_page.py")
...
def test_required_patterns():
    """Uptime Kuma Status Page page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Uptime Kuma Status Page page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Uptime Kuma Status Page — basic file sanity."""
    assert "uptime_kuma_status_page" != ""
