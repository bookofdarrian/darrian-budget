...
PAGE_PATH = os.path.join(ROOT, "pages/60_recurring_income_tracker.py")
...
def test_required_patterns():
    """Recurring Income Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Recurring Income Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Recurring Income Tracker — basic file sanity."""
    assert "recurring_income_tracker" != ""
