...
PAGE_PATH = os.path.join(ROOT, "pages/80_wedding_budget_planner.py")
...
def test_required_patterns():
    """Wedding Budget Planner page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Wedding Budget Planner page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Wedding Budget Planner — basic file sanity."""
    assert "wedding_budget_planner" != ""
