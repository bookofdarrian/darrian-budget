...
PAGE_PATH = os.path.join(ROOT, "pages/123_soleops_shipping_calculator.py")
...
def test_required_patterns():
    """SoleOps Shipping Calculator page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """SoleOps Shipping Calculator page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """SoleOps Shipping Calculator — basic file sanity."""
    assert "soleops_shipping_calculator" != ""
