...
PAGE_PATH = os.path.join(ROOT, "pages/53_savings_rate_optimizer.py")
...
def test_required_patterns():
    """Savings Rate Optimizer page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Savings Rate Optimizer page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Savings Rate Optimizer — basic file sanity."""
    assert "savings_rate_optimizer" != ""
