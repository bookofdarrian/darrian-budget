...
PAGE_PATH = os.path.join(ROOT, "pages/59_hsa_receipt_auto_categorizer.py")
...
def test_no_hardcoded_secrets():
    """HSA Receipt Auto-Categorizer page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    ...
    assert "hsa_receipt_auto_categorizer" != ""
