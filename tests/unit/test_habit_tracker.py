...
PAGE_PATH = os.path.join(ROOT, "pages/75_habit_tracker.py")
...
def test_required_patterns():
    """Habit Tracker page follows peachstatesavings.com coding standards."""
    src = _source()
...
def test_no_hardcoded_secrets():
    """Habit Tracker page must not contain hardcoded API keys or passwords."""
    src = _source()
...
def test_feature_metadata():
    """Habit Tracker — basic file sanity."""
    assert "habit_tracker" != ""
